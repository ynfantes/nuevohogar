...
// </editor-fold>
    ...
    case "clave-servicio-propietarios-sin-ingresar":
        $propietario = new propietario();
        if (!is_numeric($id))
            $id = null;
        $propietario->envioMasivoEmail("[Más fácil!] Servicio condominio en línea", '../plantillas/clave-servicio.html', $id,TRUE);
        break;
}
