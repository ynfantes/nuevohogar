...
//-------------
/*echo '***********************<br/>';
echo 'Estimado cliente: <br/>Por favor renueve el servicio de hospedaje web del año 2018 antes del viernes 12/04/2019<br/>';
echo '***********************<br/>';*/
//-------------
$tablas = array("DetFact", "facturas", "propiedades", "propietarios", "junta_condominio", "inmueble", "inmueble_deuda_confidencial","grupo","grupo_propietario","fondos_movimiento");
...
echo 'Estimado cliente: <br/>Por favor renueve el servicio de hospedaje web del año 2018 antes del viernes 12/04/2019<br/>';
echo '***********************<br/>';
$mensaje.= '<br>Estimado cliente: <br/>Por favor renueve el servicio de hospedaje web del año 2018 antes del viernes 12/04/2019<br/>';*/
//-------------
$mail = new mailto(SMTP);
$r = $mail->enviar_email("Actualización ".NOMBRE_APLICACION." ".$fecha,$mensaje, "", 'info@administradoranuevohogar.com.ve',"");
